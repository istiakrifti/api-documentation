...
app = FastAPI(
    ...
    description="API documentation for an AI-powered trip planning and management platform",
    version="1.0.0",
    openapi_tags=[
...
async def invite_to_group(invite: GroupInvite = Body(
    ...,
    example={
        "email": "user@example.com",
...
# Trip Plan Router
trip_plan_router = APIRouter(prefix="/tripPlan", tags=["TripPlan"])
...
async def extract_trip_plan(text: TripPlanExtractRequest = Body(
    ...,
    example={
        "text": "journey from dhaka to sylhet with 3 friends 4 days budget 5k"
    }
)):
    """
...
async def generate_trip_plan(trip_request: RecommendationRequest = Body(
    ...,
    example={
        "location": {
            "city": "Dhaka",
        ...
        "travel_dates": ["2024-10-24", "2024-10-27"],
        "preferences": {
            "activities": ["sightseeing", "nature"],
            "food": ["local", "traditional"]
        },
        "budget_range": {
            "min": 1500.0,
            "max": 5000.0
...
@recommendations_router.post("", response_model=List[Recommendation],
                           responses={
                               200: {
                                   "content": {
                                       "application/json": {
                                           "example": [
                                               {
                                                   ...
                                                   "type": "DESTINATION",
                                                   "title": "Eiffel Tower",
                                                   "description": "The iconic Parisian landmark",
                                                   "location": {
                                                       "city": "Paris",
                                                       "country": "France",
                                                       "latitude": 48.8584,
                                                   ...
                                                   "tags": ["landmark", "must-visit", "romantic"]
                                               },
                                               {
                                                   "id": "2",
                                                   "type": "ACTIVITY",
                                                   ...
                                                   "tags": ["cruise", "sightseeing", "relaxing"]
                                               }
                                           ]
                                       }
                                   }
...
async def get_recommendations(req: RecommendationRequest = Body(
    ...,
    example={
        "location": {
            "city": "Paris",
        ...
        "travel_dates": ["2025-06-01", "2025-06-07"],
        "preferences": {
            "activities": ["sightseeing", "culture"],
            "food": ["french", "vegetarian"]
        },
        "budget_range": {
            "min": 100.0,
            "max": 500.0
    ...
    """
    Get AI-powered travel recommendations based on your preferences.
    """
    # This is just an example implementation
    rec1 = {
        "id": "1",
    ...
    return [Recommendation(**rec1), Recommendation(**rec2)]
...
async def mark_place_visited(place_update: PlaceUpdateRequest = Body(
    ...,
    example={
...
async def add_place_to_todolist(place_update: PlaceUpdateRequest = Body(
    ...,
    example={
